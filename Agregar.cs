...
namespace Ingles
{
    public partial class Agregar : Form
    {
        ...
        {
            SqlConnection connection = new SqlConnection(Configuracion.sql);
        ...
        void AgregarDatos(SqlConnection cn, string esp, string eng)
        {
            ...
            try
            {
                string query = "insert into Palabra (ct, espaniol,ingles,Correcto,Incorrecto) values (1,@espaniol,@ingles,0,0)";
